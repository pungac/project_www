    ...
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item active px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="register.php">Account</a>
            </li>
            <li class="nav-item px-lg-4">
        ...
        <div class="hero-content pb-5 text-center"><br><br>
          <h1 class="hero-heading"><b>Registration Complete</b></h1>
        </div>
      </div>

    <section class="pb-5">
      <div class="container text-center">
        <div class="icon-rounded bg-primary mb-3 mx-auto text-white"><br>
          <h4 class="mb-3 ff-base">You are Registered Now! Enjoy Your Benefits!</p>
        <p> <a href="tips.php" class="btn btn-outline-dark">Check our Tips and Recipes</a></p><br>
        </div>
